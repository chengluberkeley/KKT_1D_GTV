...
void l2l2Profile(int rounds, const std::string& path) {
    ...
    std::vector<gen_data_type> inputSizeDataType = {KKT_LP_LQ};
    ...
    std::vector<gen_data_type> lambdaDataType = {KKT_LP_LQ};
